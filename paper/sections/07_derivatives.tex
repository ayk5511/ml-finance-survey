...
\begin{itemize}[leftmargin=*]
    ...
    \item \citet{Ruf2020} provide a comprehensive comparison of neural network approaches to option pricing, including data-driven models (trained on market data), model-driven approaches (trained on model outputs), and hybrid methods. They find that data-driven approaches outperform parametric models for plain vanilla options but struggle with illiquid exotics.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{SVI and beyond:} The Stochastic Volatility Inspired (SVI) parameterization \citep{Gatheral2014} remains the industry benchmark. ML approaches must be compared against this well-calibrated parametric model, and gains are typically in the tails and short maturities.
\end{itemize}
