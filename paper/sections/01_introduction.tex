...
\begin{enumerate}[leftmargin=*]
    \item \textbf{Standardized comparison tables.} For each domain, we report the dataset, sample period, ML method, benchmark, performance metric, and (the field's blind spot) whether the code and data are publicly available. Most prior surveys describe methods in prose; we tabulate them so readers can compare directly.
