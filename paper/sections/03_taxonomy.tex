...
Tree-based ensembles dominate structured (tabular) financial data. The
family includes random forests \citep{Breiman2001} and gradient-boosted
decision trees \citep{Friedman2001}, with modern implementations such as
XGBoost \citep{Chen2016}, LightGBM \citep{Ke2017}, and CatBoost
\citep{Prokhorenkova2018}. Their advantages in financial applications
include:
